    ...
    <section className="relative bg-gradient-to-br from-primary/5 via-background to-secondary/5 min-h-screen flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-center mb-8">
            <div className="relative group">
              ...
              <img 
                ...
                className="relative h-48 w-48 md:h-64 md:w-64 drop-shadow-2xl 
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-primary font-semibold mb-4 flex items-center justify-center gap-2">
